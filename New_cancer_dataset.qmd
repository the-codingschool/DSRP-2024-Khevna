...
## worst 
for(var in shortened_data){
  lineplot_concave.points_worst = ggplot(data = shortened_data, aes(x = var, y = concave.points_worst)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "concave.points_worst") 
  plot(lineplot_concave.points_worst)}
## mean 
for(var in shortened_data){
  lineplot_concave.points_mean = ggplot(data = shortened_data, aes(x = var, y = concave.points_mean)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "concave.points_mean") 
  plot(lineplot_concave.points_mean)}
...
##worst 
for(var in shortened_data){
  lineplot_concavity_worst= ggplot(data = shortened_data, aes(x = var, y = concavity_worst)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "concavity_worst") 
  plot(lineplot_concavity_worst)}

##mean
for(var in shortened_data){
  lineplot_concavity_mean = ggplot(data = shortened_data, aes(x = var, y = concavity_mean)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "concavity_mean") 
  plot(lineplot_concavity_mean)}
...
for(var in shortened_data){
  lineplot_compactness_worst = ggplot(data = shortened_data, aes(x = var, y = compactness_worst)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "compactness_worst") 
  plot(lineplot_compactness_worst)}

## Mean 

for(var in shortened_data){
  lineplot_compactness_mean = ggplot(data = shortened_data, aes(x = var, y = compactness_mean)) +
  geom_point() +
  labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
       x = var,
       y = "compactness_mean") 
  plot(lineplot_compactness_mean)}
```
...
for(var in column_names){
  ...
  scatterplot = ggplot(data = data, aes_string(x = var, y = "concave.points_worst")) +
    geom_point() +
    labs(title = "Line Plot: Looking for linear relationship for a possible LR model",
         x = var,
         y = "concave.points_worst") 
