...
## Decoding Breast Cancer Cells: What are their most important features? What makes those features different from a regular cell? And, how well can we use these differences to predict whether a cell is malignant or Benign?
...
#for(var in numericalData){
  #boxplot = boxplot(numericalData$var,
...
c("diagnosis", "radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst"))
```

## **Why just two components - because it explains most of the variability and easier to work with**

## Working with least Cos 2 value data

```{r}
lowcor_shortened_data = select(cleaned_num_data, c("diagnosis", "area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se"))

head(lowcor_shortened_data)
```

**Plotting the data**

```{r}
corPlot(lowcor_shortened_data, cex = .5, xsrt = 90, ysrt = 90, cex.axis = .75, cex.yaxis = .5, stars =TRUE)

correlation_matrix <- cor(lowcor_shortened_data, use = "everything")
ggcorrplot(correlation_matrix) + theme(axis.text.y = element_text(size = 6), axis.text.x = element_text(angle = 90, hjust = 1, size = 6))

model.matrix(~0+., data=lowcor_shortened_data) %>% 
  cor(use="everything") %>% 
  ggcorrplot(show.diag=FALSE, type="lower", lab=TRUE, lab_size=2) + theme(axis.text.y = element_text(size = 6), axis.text.x = element_text(angle = 90, hjust = 1, size = 6))
...
library(readxl)
set.seed(42)
split_lowcor = sample.split(lowcor_shortened_data$diagnosis, SplitRatio = 0.8)

train_data_lowcor = subset(lowcor_shortened_data, split == TRUE)
test_data_lowcor = subset(lowcor_shortened_data, split == FALSE)

numbers_lowcor <- c(1:100)
results_lowcor <- numeric()
for (num in numbers_lowcor){
  knn_model_lowcor = knn(train = train_data_lowcor[, c("area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se")], 
                test = test_data_lowcor[, c( "area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se")], 
                cl = train_data_lowcor$diagnosis, 
                k = num)
  pred_lowcor = knn_model_lowcor
  confusion_matrix_lowcor = table(test_data_lowcor$diagnosis, pred_lowcor)
  accuracy_lowcor = sum(diag(confusion_matrix_lowcor)) / sum(confusion_matrix_lowcor)
  results_lowcor <- c(results_lowcor, accuracy_lowcor)
  #print(accuracy)
  }
```

```{r}
results_df_lowcor = data.frame(results_lowcor, Number_of_Neighbours = 1:100)
head(results_df_lowcor, 30)
```

```{r}
ggplot(data = results_df_lowcor, aes( x = Number_of_Neighbours, y = results_lowcor)) +
  geom_line() +
  labs(title = "Error", 
       x = "# Neighbours",
       y = "Accuracy") 
...
```{r}
filtered_results_lowcor = filter(results_df_lowcor, Number_of_Neighbours < 30, Number_of_Neighbours > 20)
```

```{r}
ggplot(data = filtered_results_lowcor, aes( x = Number_of_Neighbours, y = results_lowcor)) +
  geom_line() +
  labs(title = "Error", 
       x = "# Neighbours",
       y = "Accuracy") 
...
**25 and 28 are optimal numbers according to the table** **highest accuracy 85**

## Visualizations with highly cor data
...
**Note: Should the data be corelated? because aren't PCA components inherently unrelated?**
...
## Main: Making a KNN Model using highly cor data - Predicting of a cell is cancerous or not
...
results <- numeric()
for (num in numbers){
  knn_model = knn(train = train_data[, c( "radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
                test = test_data[, c( "radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
...
```{r}
knn_model_20 = knn(train = train_data[, c("radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
                test = test_data[, c("radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
                cl = train_data$diagnosis, 
                k = 20)
```
...
knn_model_22 = knn(train = train_data[, c("radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
                test = test_data[, c("radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst", "concavity_worst")], 
                cl = train_data$diagnosis, 
                k = 22)
...
**KNN model with only five variables**

```{r}
numbers_5 <- c(1:100)
results_5 <- numeric()
for (num in numbers_5){
   knn_model_5 = knn(train = train_data[, c("radius_mean", "concave.points_mean" , "concavity_mean", "concavity_worst", "compactness_mean")], 
                test = test_data[, c("radius_mean", "concave.points_mean" , "concavity_mean", "concavity_worst", "compactness_mean")], 
                cl = train_data$diagnosis, 
                k = num)
  pred_5 = knn_model_5
  confusion_matrix_5 = table(test_data$diagnosis, pred_5)
  accuracy_5 = sum(diag(confusion_matrix_5)) / sum(confusion_matrix_5)
  results_5 <- c(results_5, accuracy_5)
  #print(accuracy)
  }
#print(accuracy)
#print(results)
...
```{r}
results_df_5 = data.frame(results_5, Number_of_Neighbours = 1:100)
head(results_df_5, 10)
```

```{r}
ggplot(data = results_df_5, aes( x = Number_of_Neighbours, y = results_5)) +
  geom_line() +
  labs(title = "Error", 
       x = "# Neighbours",
       y = "Accuracy") 
...
## Making a Logistics Regression Model with Highly Correlated Data
...
```{r}
df_lr = chr_shortened_data
head(df_lr)
df_lr$diagnosis = as.factor(df_lr$diagnosis) ## making the target variable a factor 
```

```{r}
# Split data into train and test
set.seed(42)
split <- initial_split(df_lr, prop = 0.8, strata = diagnosis)
```
...
#install.packages("glmnet")
library(glmnet)
lg_model <- logistic_reg(mixture = 1, penalty = 1) %>%
  set_engine("glmnet") %>%
...
```{r}
# Class Predictions
pred_class <- predict(lg_model,
                      new_data = test,
                      type = "class")

# Class Probabilities
pred_proba <- predict(lg_model,
                      new_data = test,
                      type = "prob")
```
...
accuracy(results, truth = diagnosis, estimate = .pred_class)
```

## Making a KNN model with all the features

```{r}
set.seed(42)
split_all = sample.split(cleaned_data$diagnosis, SplitRatio = 0.8)
train_data_all = subset(cleaned_data, split == TRUE)
test_data_all = subset(cleaned_data, split == FALSE)
```
...
for (num in numbers_all){
  knn_model_all = knn(train = train_data_all[, c( "radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean",   "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_se", "area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se")], 
                test = test_data_all[, c( "radius_mean", "radius_worst","area_mean","area_worst","perimeter_mean", "perimeter_worst", "concave.points_mean" , "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_se", "area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se")], 
                cl = train_data_all$diagnosis, 
                k = num)
  pred_all = knn_model_all
  confusion_matrix_all = table(test_data_all$diagnosis, pred_all)
  accuracy_all = sum(diag(confusion_matrix_all)) / sum(confusion_matrix_all)
  results_all <- c(results_all, accuracy_all)
  #print(accuracy_all)
  }
```

```{r}
results_df_all = data.frame(results_all, Number_of_Neighbours = 1:100)
head(results_df_all, 10)
```

```{r}
ggplot(data = results_df_all, aes( x = Number_of_Neighbours, y = results_all)) +
  geom_line() +
  labs(title = "Error", 
       x = "# Neighbours",
       y = "Accuracy") 
...
```{r}
filtered_results_all = filter(results_df_all, Number_of_Neighbours < 25, Number_of_Neighbours > 18.5)
print(filtered_results_all)
```

```{r}
ggplot(data = filtered_results_all, aes( x = Number_of_Neighbours, y = results_all)) +
  geom_line() +
  labs(title = "Error", 
       x = "# Neighbours",
       y = "Accuracy") 
...
**Creating a KNN model with all features only yeilds an accuracy of highest 0.9292035 at k = 20 - 23 (inclu).**

**Creating a KNN model with highly corelated features yeilds an accuracy of 0.9292035 at k = 20 and 22.**

**We can therefore conculde the least correlated variables are not important to the knn model.**
...
```{r}
anov_test = aov(diagnosis ~ radius_mean + radius_worst + area_mean + area_worst + perimeter_mean + perimeter_worst + concave.points_mean + concave.points_worst + concavity_mean + concavity_worst + compactness_mean + compactness_worst, data = shortened_data)

summary(anov_test)

df_anov_test = as.data.frame(summary(anov_test)[[1]])
head(df_anov_test, 12)
```
...
```{r}
df_anov_test = df_anov_test[order(df_anov_test$Pr, decreasing = TRUE),]  
head(df_anov_test, 12)
```

## Doing a T-test for all highly cor variables

```{r}
names(shortened_data)
```
...
## Making a tibble using the data of HIGHEST CORRELATED VARIABLES from the t_test
...
## doing a t-test on all variables 
t_test_results <- lapply(shortened_data[-1], function(x) t.test(x ~ shortened_data$diagnosis))

# Use purrr::map to apply tidy() to each element in t_test_results
tidy_results <- map_df(t_test_results, broom::tidy)

# renaming the columns 
tidy_results = rename(tidy_results, mean_benign_minus_malignant = estimate)
tidy_results = rename(tidy_results, mean_benign_cell = estimate1)

# adding column with variable names 
tidy_results = add_column(
  tidy_results,
  #before = "mean_benign_minus_malignant",
  #after = NULL,
  variable_name = c("radius_mean", "radius_worst", "area_mean", "area_worst", "perimeter_mean", "perimeter_worst", "concave.points_mean", "concave.points_worst", "concavity_mean", "concavity_worst", "compactness_mean", "compactness_worst")
)

## creating a new column using the data from existing column 
tidy_results <- transform( 
  tidy_results, mean_malignant_cell= num(mean_benign_cell) - num(mean_benign_minus_malignant))

## dropping columns parameter and estimate2 and reordering the columns 
tidy_results = select(tidy_results, c("variable_name", "mean_benign_cell", "mean_malignant_cell", "mean_benign_minus_malignant", "statistic", "p.value", "conf.low", "conf.high", "method", "alternative"))


# Print the results

head(tidy_results, 12)
...
```{r}
#?ggplot #do the p-value 
?grom_bar
ggplot(tidy_results, aes(y = p.value, x = variable_name)) +
  geom_bar(stat="summary", fun = "mean") + 
  labs(title = "Counts of Vehicles by Class",
       x = "Vehicle Class",
       y = "Count")
```

## Completing a t-test of the least correlated values

```{r}
lowcor_t_test_results = lapply(lowcor_shortened_data[-1], function(x) t.test(x ~ shortened_data$diagnosis))
#print(lowcor_t_test_results)
```

##Making a Tibble using least cor data##

```{r}
#names(lowcor_shortened_data)

#lowcor_t_test_results = lapply(lowcor_shortened_data[-1], function(x) t.test(x ~ shortened_data$diagnosis))

#making the tibble
lowcor_tidy_results = map_df(lowcor_t_test_results, broom::tidy)

#renaming columns 
lowcor_tidy_results = rename(lowcor_tidy_results, mean_benign_cell = estimate1)
lowcor_tidy_results = rename(lowcor_tidy_results, mean_malignant_cell = estimate2)

## making a new column 
lowcor_tidy_results <- transform( 
  lowcor_tidy_results, mean_benign_minus_malignant= num(mean_benign_cell) - num(mean_malignant_cell))

# adding column with variable names 
lowcor_tidy_results = add_column(
  lowcor_tidy_results,
  #before = "mean_benign_minus_malignant",
  #after = NULL,
  variable_name = c("area_se", "radius_se", "perimeter_se", "texture_mean", "texture_worst", "symmetry_worst", "texture_se", "symmetry_se", "smoothness_se", "symmetry_mean", "concave.points_se", "concavity_se", "smoothness_worst", "compactness_se", "fractal_dimension_worst", "smoothness_mean", "fractal_dimension_se")
)


## dropping columns parameter and estimate2 and reordering the columns 
lowcor_tidy_results = select(lowcor_tidy_results, c("variable_name", "mean_benign_cell", "mean_malignant_cell", "mean_benign_minus_malignant", "statistic", "p.value", "conf.low", "conf.high", "method", "alternative"))

head(lowcor_tidy_results, 17)

str(lowcor_tidy_results)
...
## Scatter Plot for Concave Points

```{r}
column_names <- colnames(shortened_data)
column_names

for(var in column_names){
  if (var != "concave.points_worst") {
  scatterplot_concave.points_worst = ggplot(data = chr_shortened_data, aes_string(x = var, y = "concave.points_worst")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "concave.points_worst") 
  plot(scatterplot_concave.points_worst)}}

for(var in column_names){
  if (var != "concave.points_mean") {
  scatterplot_concave.points_mean = ggplot(data = chr_shortened_data, aes_string(x = var, y = "concave.points_mean")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "concave.points_mean") 
  plot(scatterplot_concave.points_mean)}}
```

## Scatter Plot for Concavity
...
for(var in column_names){
  if (var != "concavity_worst") {
  scatterplot_concavity_worst = ggplot(data = chr_shortened_data, aes_string(x = var, y = "concavity_worst")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "concavity_worst") 
  plot(scatterplot_concavity_worst)}}

for(var in column_names){
  if (var != "concavity_mean") {
  scatterplot_concavity_mean = ggplot(data = chr_shortened_data, aes_string(x = var, y = "concavity_mean")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "concavity_mean") 
  plot(scatterplot_concavity_mean)}}
...
for(var in column_names){
  if (var != "compactness_worst") {
  scatterplot_compactness_worst = ggplot(data = chr_shortened_data, aes_string(x = var, y = "compactness_worst")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "compactness_worst") 
  plot(scatterplot_compactness_worst)}}

for(var in column_names){
  if (var != "compactness_mean") {
  scatterplot_compactness_mean = ggplot(data = chr_shortened_data, aes_string(x = var, y = "compactness_mean")) +
    geom_point(aes(color = diagnosis)) +
    labs(title = "ScatterPlot: Visualizing differnces between malignant and benign cells",
         x = var,
         y = "compactness_mean") 
  plot(scatterplot_compactness_mean)}}
```
