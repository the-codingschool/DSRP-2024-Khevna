...
Now, notice that we used the subset and not all the variables. We need to make sure that this is reasonable, so we should compare the results from just running the ml model with just the subset with the results from running the ml models with all of the data
...
Turns out, the cross validation had no effect in this case.
