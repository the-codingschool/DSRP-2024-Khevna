...
We see that ncc is one of the better models as it is at or very close to the best in terms of both accuracy and precision. We can now look at this best model with cross validation, which we didn't explicitly include earlier.
